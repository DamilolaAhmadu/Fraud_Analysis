...
Fraud prevention is the implementation of strategies to detect fraudulent transactions or banking actions and prevent these actions from causing financial damage, the reputation of the client and the financial institution.

There are always financial frauds and they can happen throug virtual and physical ways. So the investment in securities has been increasing.
