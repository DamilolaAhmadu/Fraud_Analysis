...
The business models of the company is of the Services type with the monetizations made by the performance of the services provided, in other words, the user pays a fixed fee on the success of detecting fraud in the customer's transactions.
