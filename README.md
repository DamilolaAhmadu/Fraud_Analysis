...
Fraud prevention is the implementation of strategies in to detect fraudulent transactions or banking actions and to prevent these actions from causing financial damage, the reputation of the client and the financial institution.
...
The data is extremely unbalance, however it was possible to make all the data analysis and create iwith good scores.
