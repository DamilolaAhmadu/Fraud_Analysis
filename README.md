...
Fraud prevention is the implementation of strategies in or to detect fraudulent transactions or banking actions and to prevent these actions from causing financial damage, the reputation of the client and the financial institution.
