...
The business model of this company is of the Service type with the monetizations made by the performance of the services provided, in other words, the users pays a fixed fee on the success of detecting frauds in the customer's transactions.
